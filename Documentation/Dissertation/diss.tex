...
public class ProbabilityDistribution implements Serializable {
  ...
  ...
                ...
                \begin{table}[H]
                    ...
                    \end{tabularx}
                    \caption[justification=justified,singlelinecheck=false]{Important methods implemented in the \texttt{ProbabilityDistribution} class.}
            ...
            \subsubsection{Weak Learners} \label{sec:weak_learner}
                ...
                \begin{figure}[H]
                    ...
                    \caption[justification=justified,singlelinecheck=false]{\raggedright A closer view of \texttt{WeakLearner} and \texttt{OneDimensionalLinearWeakLearner} 
                    in Figure \ref{fig:forest_uml}.}
